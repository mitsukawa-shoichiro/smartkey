...
def camera_regisit_view(page: ft.Page) -> ft.View:
...
def main(page: ft.Page):
    def route_change(e: ft.RouteChangeEvent):
        ...
        if page.route in ("/", "/camera/register"):
            page.views.append(camera_regisit_view(page))
        page.update()
