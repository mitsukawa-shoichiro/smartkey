...
#     start_time = ft.TimePicker(value=time(0, 0), on_change=change_start_time)
#     end_time = ft.TimePicker(value=time(23, 59), on_change=change_end_time)
...
#     def get_start_datetime(date_picker, time_picker):

#         start_date = date_picker.value
#         start_time = time_picker.value
...
#     def get_end_datetime(date_picker, time_picker):

#         end_date = date_picker.value
#         end_time = time_picker.value
...
#             [
#                 ft.Row([searchcardname, searchmethod, searcheventtype], spacing=20),
#                 ft.Row([ft.Text("開始日時:", width=80), startdate_btn], spacing=10),
#                 ft.Row([ft.Text("終了日時:", width=80), enddate_btn], spacing=10),
#                 ft.Row([search_btn,show_all_btn], alignment=ft.MainAxisAlignment.END, spacing=20),
#             ],
#             spacing=15,
#             horizontal_alignment=ft.CrossAxisAlignment.START
